...
<br>
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/RemusRigo/BackupMyProject-PowerShell/total)



## Roadmap

* 2025-07-22: Add: modify Install.ps1 to create .bat file directly in the SendTo folder
* 2025-06-30: Add: project redesigned
